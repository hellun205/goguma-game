...
namespace Audio
{
  ...
  public class AudioManager : MonoBehaviour
  {
    ...
    public static void Play(AudioData audio, float delay = 0f)
      => Instance.PlaySound(audio, delay);

    public static void Play(string clipName, float delay = 0f)
      => Instance.PlaySound(clipName, delay);

    public static void SetVolume(float volume)
      => Instance.SetVolumes(volume);
  }
}